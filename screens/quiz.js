...
import { ativarVibracao, tocarMelodiaMusica, tocarSom, salvarPontuacaoLocalmente } from '../services/funcoes_service';
...
export default function Quiz({ aoNavegar }) {
  ...
  const aoSalvarPontuacao = async () => {
    ...
    const sucesso = await salvarPontuacaoLocalmente(nomeUsuario, pontuacao, dificuldade);
  ...
  if (quizFinalizado) {
    ...
    if (porcentagem === 100) {
      mensagem = 'Vsocê realmente sabe tudo';
    ...
    return (
      <View style={stylesLocal.container}>
        <View style={stylesLocal.cardFim}>
          ...
          <Text style={stylesLocal.porcentagemTexto}>{porcentagem}% de acertos</Text>
    ...
    >
      <View style={[
        ...
        <View style={stylesLocal.headerQuiz}>
          ...
          <Text style={stylesLocal.pontosTexto}>
            {pontuacao} pts
          </Text>
        </View>
        ...
        {type === 'music' && (
          <TouchableOpacity 
            ...
            onPress={() => tocarMelodiaMusica(song)}
            activeOpacity={0.8}
          >
            <Text style={stylesLocal.textoMelodia}>Tocar Melodia</Text>
          </TouchableOpacity>
        )}
